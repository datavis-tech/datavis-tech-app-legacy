...
export default PublicPage(() => (
  <Layout>
    ...
    <ul>
      ...
      <li><strong style={{color:'red'}}>Fail Fast Note</strong>: We have found that weekly communication is critical for data visualization projects. If no one from your team is available to meet with us for 30 minutes to 1 hour on a weekly basis, we will not be able to proceed.</li>
